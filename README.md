...
1. **`pmp_quest.html`** — the game itself (89 KB)
2. **`PMBOK7.pdf`** — the official PMBOK 7 Guide (4.4 MB)
...
1. Download **both** `pmp_quest.html` **and** `PMBOK7.pdf` from this repository
2. Save them **in the same folder** on your computer (Desktop, Documents, etc.)
3. Double-click `pmp_quest.html` — it opens in your default browser
4. Click the "PMBOK 7 Guide" button at the top to read the full guide inside the game
...
3. Share the live URL: `https://yourusername.github.io/pmp-quest/pmp_quest.html`
4. Team members access via link — the PDF loads from the repo automatically
5. Each person's progress saves locally on their own device
